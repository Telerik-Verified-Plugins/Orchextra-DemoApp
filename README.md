...
<a href="https://platform.telerik.com/#appbuilder/clone/https%3a%2f%2fgithub.com%2fTelerik-Verified-Plugins%2fOrchextra-DemoApp" target="_blank"><img src="http://docs.telerik.com/platform/samples/images/try-in-appbuilder.png" alt="Try in AppBuilder" title="Try in AppBuilder" /></a>  
...
This sample app shows you how to add Orchextra capabilities to your app using the Orchextra plugin from the [Telerik Verified Plugins Marketplace][marketplace].
...
1. Enter `https://github.com/Telerik-Verified-Plugins/Orchextra-DemoApp.git` in the **Repository URI** text box.
...
1. On your local file system, clone the [remote repository](https://github.com/Telerik-Verified-Plugins/Orchextra-DemoApp) that contains the app.
